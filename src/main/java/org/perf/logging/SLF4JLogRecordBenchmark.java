...
public class SLF4JLogRecordBenchmark {
    ...
    @Benchmark
    public void l07_guarded_unparametrized() {
        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("Result [" + aString + "], [" + (++anInt) + "], [" + aBoolean + "], [" + (aFloat++) + "], [" + aChar + "]");
        }
    }
...
//    @Benchmark
//    public void l08_string_template_heap() {
//        LOGGER.debug(STR."Result [\{aString}], [\{++anInt}], [\{aBoolean}], [\{aFloat++}], [\{aChar}]");
//    }
//
//    @Benchmark
//    public void l09_string_template_local() {
//        String localString = aString;
//        int localInt = ++anInt;
//        boolean localBoolean = aBoolean;
//        float localFloat = aFloat++;
//        char localChar = aChar;
//        LOGGER.debug(STR."Result [\{localString}], [\{localInt}], [\{localBoolean}], [\{localFloat}], [\{localChar}]");
//    }
